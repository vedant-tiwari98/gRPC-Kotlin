...
import com.kotlingrpc.demoGrpc.GreeterGrpc.getServiceDescriptor
...
/**
 * Holder for Kotlin coroutine-based client and server APIs for com.kotlingrpc.demoGrpc.Greeter.
 */
object GreeterGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) com.kotlingrpc.demoGrpc.Greeter service as suspending
   * coroutines.
   */
  ...
  /**
   * Skeletal implementation of the com.kotlingrpc.demoGrpc.Greeter service based on Kotlin
   * coroutines.
   */
  abstract class GreeterCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for com.kotlingrpc.demoGrpc.Greeter.SayHello.
     *
    ...
    open suspend fun sayHello(request: HelloRequest): HelloReply = throw
        StatusException(UNIMPLEMENTED.withDescription("Method com.kotlingrpc.demoGrpc.Greeter.SayHello is unimplemented"))
